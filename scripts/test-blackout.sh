...
#python $src/rnnlm.py --word_dim 10000 --hidden_dim 50 --batch_size 15 --epoch 5 --data_size 10000 --sort 1 --network RNN --test_data_size 3000 --training_data $data/news.en-00001-of-00100 
...
#python $src/rnnlm.py --word_dim 10000 --hidden_dim 50 --class_dim 100 --class_type 0 --batch_size 15 --epoch 5 --sort 1 --data_size 10000 --test_data_size 3000 --training_data $data/news.en-00001-of-00100
