...
# 動的にノイズ分布を変更していくNCEで言語モデルをつくる RNN Language Model using Adaptive Noise NCE
class RNN_ANNCE:
    def __init__(self, unigram, word_dim, hidden_dim=100, bptt_truncate=4):
        ...
        self.R = np.random.uniform(-np.sqrt(1. / hidden_dim), np.sqrt(1. / hidden_dim), (word_dim, hidden_dim))
