...
plot_name = "rnn-vs-2input-train10000-h50-b15"
...
data1 = pd.read_csv("rnn-s10000-h50-b15.csv")
data2 = pd.read_csv("rnn-lin2in-train10000-h50-b15.csv")
sns.pointplot(
    x='epoch',
    y='PPL',
    data=data1,
...
sns.plt.title(u"RNNと２入力RNNの比較、言語モデル実験",fontproperties=fp)
sns.plt.ylim(0, 140)
