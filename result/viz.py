...
plot_name = "rnn-vs-2input-test3000-h50-b15"
...
red_patch = mpatches.Patch(color='red',label=u'2 input RNN')
sns.plt.legend(handles=[blue_patch,red_patch],prop=fp)

data1 = pd.read_csv("rnn-test-s10000-h50-b15.csv")
data2 = pd.read_csv("rnn-lin2in-test3000-h50-b15.csv")
sns.pointplot(
    x='epoch',
    y='PPL',
    data=data1,
...
sns.plt.title(u"テストデータに対するRNNと２入力RNNの比較",fontproperties=fp)
sns.plt.ylim(30, 100)
